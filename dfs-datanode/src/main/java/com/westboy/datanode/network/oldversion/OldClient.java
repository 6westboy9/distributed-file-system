...
public class OldClient {
    ...
    public void sendFile(String ip, int nioPort, byte[] file, String filename, long fileSize) {
    ...
    public byte[] readFile(String ip, int nioPort, String filename) {
